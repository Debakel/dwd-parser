...
def read_dataset(dirname=None, filename_metadaten=None, filename_tageswerte=None):
	'''
	@dirname: Ordner mit Stationsbeobachtungen (produkt_*.txt) und Stationsmetadaten (Stationsmetadaten*.txt). 
	Ist dirname gesetzt, wird filename_medataten und filename_tageswerte ermittelt.
	
	@filename_metadaten: Datei mit Stationsmetadaten
	@filename_tageswerte: Datei mit Stationsbeobachtungen 
	@returns: list[] mit Messwerten
	'''
